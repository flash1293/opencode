...
function init() {
  ...
  return {
    ...
    replace(input: any, onClose?: () => void, dismissable = true) {
    ...
    <ctx.Provider value={value}>
      ...
      >
        <Show when={value.stack.length}>
          <Dialog onClose={() => { if (value.stack.at(-1)?.dismissable) value.clear() }} size={value.size}>
